...
//		this.productService.updateProduct();
	...
	public String profileDisplay(Model model) {
		...
		try
		{
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ecommjava","root","${db.password}");
	...
	
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ecommjava","root","TARHOUNI.nourhene123");
